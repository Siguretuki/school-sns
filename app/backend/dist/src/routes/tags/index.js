...
import { addTagSchema, getTagsQuerySchema, tagSchema, updateTagSchema, } from './schema.js';
...
}), validator('query', getTagsQuerySchema), async (c) => {
...
}), validator('json', addTagSchema), async (c) => {
...
}), validator('json', updateTagSchema), async (c) => {
    const data = c.req.valid('json');
    const { tagId } = c.req.param();
