...
export const users = new Hono()
...
}), validator('json', editUserRequestSchema), authCheck, async (c) => {
    const userId = c.var.user.userId;
    ...
    .post('/:userId/follow', describeRoute({
    tags: ['Users'],
    ...
    if (result.type === 'Failure') {
        return c.json({ message: result.error.message }, result.error instanceof CannotFollowSelfError ? 400 : 409);
    }
    return c.json({
        message: 'Successfully followed the user',
    }, 200);
})
    .delete('/:userId/follow', describeRoute({
    tags: ['Users'],
    ...
    .get('/:userId/followers', describeRoute({
    tags: ['Users'],
    ...
    .get('/:userId/following', describeRoute({
    tags: ['Users'],
    ...
    .get('/:userId/contents', describeRoute({
    tags: ['Users'],
